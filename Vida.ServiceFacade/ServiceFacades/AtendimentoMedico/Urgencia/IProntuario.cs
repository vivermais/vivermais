...
namespace ViverMais.ServiceFacade.ServiceFacades.AtendimentoMedico.Urgencia
{
    ...
    {
        string IniciarAtendimento<U>(U usuario, string co_pacienteViverMais, char classificacaoAcolhimento);
        ...
        P BuscarProntuarioAberto<U, P>(string co_pacienteViverMais, U unidade);
