...
{
    public class UrgenciaServiceFacadeDAO : NHibernateDAO, IUrgenciaServiceFacade
    {
        public UrgenciaServiceFacadeDAO() : base("ViverMais")
        {
        }
        ...
        void IUrgenciaServiceFacade.Insert(object obj)
        {
            this.Insert(obj);
        }
