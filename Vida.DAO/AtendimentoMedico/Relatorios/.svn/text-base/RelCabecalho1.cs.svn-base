...
namespace Vida.DAO.AtendimentoMedico.Relatorios {
    ...
    public class RelCabecalho : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Vida.DAO.AtendimentoMedico.Relatorios.RelCabecalho.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRelCabecalho : Component, ICachedReport {
        
        public CachedRelCabecalho() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RelCabecalho rpt = new RelCabecalho();
            rpt.Site = this.Site;
            return rpt;
        }
