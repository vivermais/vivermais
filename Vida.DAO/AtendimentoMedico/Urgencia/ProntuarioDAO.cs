...
namespace ViverMais.DAO.AtendimentoMedico.Urgencia
{
    public class ProntuarioDAO : UrgenciaServiceFacadeDAO, IProntuario
    {
        ...
        string IProntuario.GerarSenhaAcolhimento(long co_prontuario)
        {
            ...
            {
                SenhadorUrgence senhador = iViverMais.ListarTodos<SenhadorUrgence>().Where(p => p.CNESUnidade == prontuario.CodigoUnidade).FirstOrDefault();
        ...
        string IProntuario.IniciarAtendimento<U>(U usuario, string co_pacienteViverMais, char classificacaoAcolhimento)
        {
            IProntuario iProntuario = Factory.GetInstance<IProntuario>();
            ...
            ViverMais.Model.PacienteUrgence paciente = Factory.GetInstance<IPacienteUrgence>().BuscarPorInicializacaoUnica<ViverMais.Model.PacienteUrgence>(pacienteViverMais.Codigo);
            //Factory.GetInstance<IPacienteUrgence>().BuscarPorCodigoViverMais<ViverMais.Model.PacienteUrgence>(co_pacienteViverMais).Where(paci => string.IsNullOrEmpty(paci.Descricao)).FirstOrDefault();
            ...
            using (Session.BeginTransaction(IsolationLevel.Serializable))
            {
                try
                {
                    ...
                    {
                        paciente = new ViverMais.Model.PacienteUrgence();
                    ...
                    ViverMais.Model.Prontuario prontuarioAberto = iProntuario.BuscarProntuarioAberto<ViverMais.Model.EstabelecimentoSaude, ViverMais.Model.Prontuario>(pacienteViverMais.Codigo, usuarioAtendimento.Unidade);
                    ...
                    //IList<ViverMais.Model.Prontuario> prontuariosAbertos = Factory.GetInstance<IProntuario>().BuscarProntuarioAberto<ViverMais.Model.EstabelecimentoSaude, ViverMais.Model.Prontuario>(co_pacienteViverMais, unidadesaude);

                    //if (prontuariosAbertos != null && prontuariosAbertos.Count() > 0)
                    //{
                    //    foreach (ViverMais.Model.Prontuario pront in prontuariosAbertos)
                    //    {
                    //        pront.Situacao = Factory.GetInstance<IUrgenciaServiceFacade>().BuscarPorCodigo<ViverMais.Model.SituacaoAtendimento>(SituacaoAtendimento.FINALIZADO);
                    ...
                    //iPacienteViverMais.BuscarPorCodigo<ViverMais.Model.Paciente>(paciente.CodigoViverMais).Idade;
                    //iProntuario.CalculaIdade(DateTime.Today, iPacienteViverMais.BuscarPorCodigo<ViverMais.Model.Paciente>(paciente.CodigoViverMais).DataNascimento);
                    prontuario.FaixaEtaria = Factory.GetInstance<IFaixaEtaria>().buscaPorIdade<ViverMais.Model.FaixaEtaria>(prontuario.Idade);
                    prontuario.Situacao = iUrgencia.BuscarPorCodigo<ViverMais.Model.SituacaoAtendimento>(SituacaoAtendimento.ATENDIMENTO_INICIAL); //situacao 1 -> encaminha o paciente para a sala de acompanhamento
        ...
        string IProntuario.IniciarAtendimento<U>(U usuario, string co_pacienteViverMais, bool desacordado,
        ...
        T IProntuario.BuscarPorNumeroProntuario<T>(long numero)
        {
            ...
            hql = "FROM ViverMais.Model.Prontuario AS p WHERE p.Numero = " + numero;
        ...
        P IProntuario.BuscarProntuarioAberto<U, P>(string co_pacienteViverMais, U unidade)
        {
            string hql = string.Empty;
            return Session.CreateQuery(@"FROM ViverMais.Model.Prontuario p WHERE " +
            " p.Paciente.CodigoViverMais IS NOT NULL AND p.Paciente.CodigoViverMais = '" + co_pacienteViverMais + "' AND p.CodigoUnidade='" + ((ViverMais.Model.EstabelecimentoSaude)(object)unidade).CNES + "'" +
        ...
        IList<T> IProntuario.BuscarProntuarioPacientesIdentificados<T>(string co_unidade, string co_pacienteViverMais)
        {
            string hql = string.Empty;
            hql = "FROM ViverMais.Model.Prontuario AS p WHERE ";
            hql += " p.CodigoUnidade='" + co_unidade + "'";
        ...
        IList<T> IProntuario.BuscarPorPacienteViverMais<T>(string co_paciente)
        {
            string hql = string.Empty;
        ...
        IList<T> IProntuario.BuscarPorPacienteViverMais<T>(string co_paciente, string co_unidade)
        {
            string hql = string.Empty;
