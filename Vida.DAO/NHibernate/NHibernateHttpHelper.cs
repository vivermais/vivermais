...
namespace ViverMais.DAO
{
    public sealed class NHibernateHttpHelper
    {
        ...
        static NHibernateHttpHelper()
        {
             ...
             * (a base de dados do ViverMais) foram criadas conexões diferentes para, caso seja necessária a mudança
             * de alguma destas bases de servidor, estas já estarem "pré-definidas", diminuindo as modificações
             * na aplicação. Além disto, estas bases já não possuem referências diretas para a base do ViverMais,
