<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormLembrarCartaoSUS.aspx.cs"
    Inherits="ViverMais.View.FormLembrarCartaoSUS" EnableEventValidation="false" %>
...
<body>
    ...
    <div>
        <fieldset class="formulario">
            ...
            <p>
                <span class="rotulo">Nome e Sobrenome</span> <span>
            ...
            <p>
                ...
                <%--<cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999" ClearMaskOnLostFocus="false"
                    UserDateFormat="DayMonthYear"
                    MaskType="Date" InputDirection="LeftToRight" TargetControlID="TextBox_DataNascimento">
