...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="top">
        ...
        <fieldset class="formulario" style="font-size: 12px; background-color: #f0f0f0">
            <br />
            Para alteração dos campos em <span style="color: #000;"><b>(Cinza)</b></span> favor
            entrar em contato com o NGI - Núcleo de Gestão da Informação.
            <br />
            <br />
            <b>Contatos: </b><b>Tel.:</b> (71) 3186-1180 / 1188 / <b>E-mail:</b> ngi.saude@salvador.ba.gov.br
        </fieldset>
        <fieldset class="formulario">
            <%--            <asp:Panel ID="panelInformação" runat="server" Visible="true">
...
--%>
            ...
            <p>
                <span class="rotulo">Via do Cartão</span> <span>
                    <asp:Label ID="lblViaCartao" runat="server" Font-Bold="True" Text="1ª"></asp:Label>
                </span>
            </p>
            <p>
                <span class="rotulo">Biometria</span> <span>
                    <asp:Label ID="lblBiometria" runat="server" Font-Bold="True" Text="Não Cadastrada"></asp:Label>
                </span>
            </p>
            <p>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="tbxNomePaciente"
                Display="Dynamic" ErrorMessage="Há caracters inválidos no Nome do Paciente" Font-Size="XX-Small"
            ...
            <asp:UpdatePanel ID="UpdatePanelNomeMae" runat="server" UpdateMode="Conditional"
                ...
                <ContentTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldNomeMae" runat="server" ControlToValidate="tbxNomeMae"
                        Display="Dynamic" ErrorMessage="Digite o Nome da Mãe do Paciente" Font-Size="XX-Small"
                        ValidationGroup="ValidationGroupCartaoSUS"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="tbxNomeMae"
                        Display="Dynamic" ErrorMessage="Há caracters inválidos no Nome da Mãe do Paciente"
                        ...
                        <span class="rotulo">Nome do Pai</span> <span>
                            ...
                            <span><span>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="tbxNomePai"
                                    Display="Dynamic" ErrorMessage="Há caracters inchkPaiIgnoradoválidos no Nome do Pai do Paciente"
                                    Font-Size="XX-Small" ValidationExpression="^[a-zA-Z\s]{1,70}$" ValidationGroup="ValidationGroupCartaoSUS"></asp:RegularExpressionValidator>
                            </span></span></span>
                    </p>
                </ContentTemplate>
            ...
            <p>
                <span class="rotulo" style="background-color: #9e9e9e; border: solid 1px #9e9e9e">Data
                    de Nascimento*</span> <span>
                        ...
                        Display="Dynamic" ErrorMessage="A data de Nascimento não parece ser válida" Font-Size="XX-Small"
            ...
            <p>
                <span class="rotulo">Raça/Cor*</span> <span>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldRacaCor" runat="server" ControlToValidate="ddlRacaCor"
                Display="Dynamic" ErrorMessage="Selecione a Raça/Cor do Paciente" Font-Size="XX-Small"
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="rbtnListFreqEscola"
                Display="Dynamic" ErrorMessage="Selecione uma opção para Frequenta Escola" ValidationGroup="ValidationGroupCartaoSUS"
                ...
                <ContentTemplate>
                    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                        <asp:View ID="ViewBrasileiro" runat="server">
                            ...
                            <p>
                                <span class="rotulo">Município de Nascimento*</span> <span>
                                    ...
                                    <asp:CustomValidator ID="CustomValidatorMunicipioNasc" runat="server" Display="Dynamic"
                                        ValidationGroup="ValidationGroupCartaoSUS" ErrorMessage="Preencha o Município de Nascimento"
                        ...
                        <asp:View ID="ViewEstrangeiro" runat="server">
                            <p>
                                <span class="rotulo">País*</span> <span>
                                ...
                                <asp:CustomValidator ID="CustomValidatorPaisNasc" runat="server" Display="Dynamic"
                                    ValidationGroup="ValidationGroupCartaoSUS" ErrorMessage="Preencha o País de Origem"
                        ...
                        <asp:View ID="ViewNaturalizado" runat="server">
                            <p>
                                <span class="rotulo">Data da Naturalização*</span> <span>
                                ...
                                <asp:CustomValidator ID="CustomValidatorDataNaturalizacao" runat="server" Display="Dynamic"
                                    ValidationGroup="ValidationGroupCartaoSUS" ErrorMessage="Preencha a Data de Naturalização"
                                    Font-Size="XX-Small" OnServerValidate="CustomValidatorDataNaturalizacao_ServerValidate"></asp:CustomValidator>
                            </p>
                            <p>
                                <span class="rotulo">Número da Portaria*</span> <span>
                                ...
                                <asp:CustomValidator ID="CustomValidatorNumPortaria" runat="server" Display="Dynamic"
                                    ValidationGroup="ValidationGroupCartaoSUS" ErrorMessage="Digite o Número da Portaria"
            ...
            <asp:UpdatePanel ID="UpdatePanelPossuiDeficiencia" runat="server" ChildrenAsTriggers="true">
                ...
                <ContentTemplate>
                    <p>
                        <span class="rotulo">Possui Deficiência*</span> <span>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator_Deficiencia" runat="server"
                                Font-Size="XX-Small" ErrorMessage="Informe se o Paciente Possui Deficência" ControlToValidate="rbDeficiencia"
            ...
            <asp:UpdatePanel ID="UpdatePanel_DeficienciaParte1" runat="server" UpdateMode="Conditional"
                ...
                <ContentTemplate>
                    <asp:Panel ID="Panel_TipoDeficiencia" runat="server" Visible="false">
                        <p>
                            <span class="rotulo">Tipo de Deficiência*</span> <span>
                                ...
                                <div style="margin-top: 13px; width: 16px; height: 18px; position: relative;">
                                    <asp:ImageButton ID="ImageButtonInformacaoTipoDeficiencia" runat="server" Width="16px"
                                        ToolTip="O que é Estomia?" Height="18px" OnClientClick="return false;" ImageUrl="~/Paciente/img/help.png" />
                                </div>
                                ...
                                <div id="info" style="display: none; width: 250px; z-index: 2; opacity: 0; filter: progid:DXImageTransform.Microsoft.Alpha(opacity=0);
                                    ...
                                    Estomia é um procedimento cirúrgico que consiste na exteriorização do sistema (digestivo,
                                    respiratório e urinário), criando um orifício externo.
                                </div>
                                <br />
                                <asp:CustomValidator ID="CustomValidator_TipoDeficiencia" runat="server" OnServerValidate="OnServerValidate_TipoDeficiencia"
                                    ErrorMessage="Selecione Pelo Menos um Tipo de Deficiência" Display="Dynamic"
                                    Font-Size="XX-Small" ValidationGroup="ValidationGroupCartaoSUS" Text="Selecione Pelo Menos um Tipo de Deficiência">
                                </asp:CustomValidator>
                        ...
                        <%--                        <p>
                            <span class="rotulo">Origem da Deficiência*</span> <span>
                                ...
                                <asp:CustomValidator ID="CustomValidator_OrigemDeficiencia" runat="server" ErrorMessage="Selecione Pelo Menos uma Origem da(s) Deficiência(s)"
            ...
            <asp:UpdatePanel ID="UpdatePanel_DeficienciaParte3" runat="server" UpdateMode="Conditional"
                ...
                <ContentTemplate>
                    <asp:Panel ID="Panel_MeioLocomocaoDeficiencia" runat="server" Visible="false">
                        <p>
                            <span class="rotulo">Meios de Locomoção*</span><span>
                                ...
                                <asp:CustomValidator Font-Size="XX-Small" ID="CustomValidator_LocomocaoDeficiencia"
                                    runat="server" ErrorMessage="Selecione Pelo Menos um Meio de Locomoção para a(s) Deficiência(s) do Paciente"
                    ...
                    <asp:Panel ID="Panel_MeioComunicacaoDeficiencia" runat="server" Visible="false">
                        <p>
                            <span class="rotulo">Meios de Comunicação*</span><span>
                                ...
                                <asp:CustomValidator Font-Size="XX-Small" ID="CustomValidator_ComunicacaoDeficiencia"
                                    runat="server" ErrorMessage="Selecione Pelo Menos um Meio de Comunicação para a(s) Deficiência(s) do Paciente"
                        ...
                        <p>
                            <span class="rotulo">Usa Ortese*</span> <span>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_Ortese" Font-Size="XX-Small"
                                    runat="server" ErrorMessage="Informe se o Paciente usa Órtese" ControlToValidate="rbOrtese"
                                    Display="Dynamic" ValidationGroup="ValidationGroupCartaoSUS"></asp:RequiredFieldValidator>
                            </span>
                        </p>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="Panel_ProteseDeficiencia" runat="server" Visible="false">
                        <%--                        <p>
                            <span class="rotulo">Usa Ortese*</span> <span>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_Ortese" runat="server" ErrorMessage="Informe se o Paciente usa Órtese"
                                    ControlToValidate="rbOrtese" Display="Dynamic" ValidationGroup="ValidationGroupCartaoSUS"></asp:RequiredFieldValidator>
                            </span>
                        </p>--%>
                        <p>
                            <span class="rotulo">Prótese*</span> <span>
                                ...
                                <asp:CustomValidator Font-Size="XX-Small" ID="CustomValidator_Protese" runat="server"
                                    OnServerValidate="OnServerValidate_Protese" ErrorMessage="Informe se o Paciente Usa Alguma Prótese"
        ...
        <fieldset class="formulario">
            ...
            <p>
                <span class="rotulo">CPF</span> <span>
                    ...
                    <asp:CompareValidator ID="CompareValidatorCPF" runat="server" ControlToValidate="tbxCPF"
                        Display="Dynamic" Font-Size="XX-Small" ErrorMessage="O CPF deve conter apenas Números"
            ...
            <p>
                <span class="rotulo">Identidade</span> <span>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel_IdentidadeParte1" runat="server" ChildrenAsTriggers="false"
                        ...
                        <ContentTemplate>
                            <asp:CompareValidator ID="CompareValidatorIdentidade" runat="server" ControlToValidate="tbxIdentidade"
                                Display="Dynamic" Font-Size="XX-Small" ErrorMessage="A Identidade deve Conter apenas Números"
                                Operator="DataTypeCheck" Type="Double" ValidationGroup="ValidationGroupCartaoSUS"></asp:CompareValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Existem Caracteres inválidos no campo Identidade"
                    ...
                    <asp:UpdatePanel ID="UpdatePanel_IdentidadeParte2" runat="server" ChildrenAsTriggers="false"
                        ...
                        <ContentTemplate>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="tbxComplementoIdentidade"
                                Display="Dynamic" Font-Size="XX-Small" ErrorMessage="A Identidade deve Conter apenas Números"
                                Operator="DataTypeCheck" Type="Double" ValidationGroup="ValidationGroupCartaoSUS"></asp:CompareValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ErrorMessage="Existem Caracteres inválidos no campo Identidade"
                                ControlToValidate="tbxComplementoIdentidade" ValidationExpression="^[a-zA-Z0-9\s]{1,10}$"
                                Font-Size="XX-Small" Display="Dynamic" ValidationGroup="ValidationGroupCartaoSUS">
                            </asp:RegularExpressionValidator>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </span><span class="rotulomin">Data da Emissão</span> <span>
                    ...
                    <asp:CompareValidator ID="CompareValidatorEmissaoIdentidade" runat="server" ControlToValidate="tbxDataEmissaoIdentidade"
                        Display="Dynamic" Font-Size="XX-Small" ErrorMessage="A Data da Emissão inválida"
                        Operator="DataTypeCheck" Type="Date" ValidationGroup="ValidationGroupCartaoSUS"></asp:CompareValidator>
                    <asp:CustomValidator ID="CVDataEmissaoIdentidade" runat="server" ErrorMessage="A Data de Emissão da Identidade deve ser maior que a Data de Nascimento e igual ou menor que a Data de Hoje"
            ...
            <p>
                <span class="rotulo">Órgão Expedidor</span> <span>
                    ...
                    <asp:CustomValidator ID="CustomValidatorOrgaoEmissor" runat="server" ControlToValidate="ddlOrgaoExpedidor"
                        Display="Dynamic" ErrorMessage="Selecione um Órgão Emissor" Font-Size="XX-Small"
            ...
            <p>
                <span class="rotulo">Certidão</span> <span>
                    <asp:DropDownList ID="ddlTipoCertidao" CssClass="campo" Height="21px" runat="server"
                        TabIndex="23">
                        <asp:ListItem Value="-1">Selecione...</asp:ListItem>
                        <asp:ListItem Value="91">Certidão de Nascimento</asp:ListItem>
                        <asp:ListItem Value="92">Certidão de Casamento</asp:ListItem>
                        <asp:ListItem Value="93">Certidão de Separação ou Divórcio</asp:ListItem>
                        <asp:ListItem Value="95">Certidão Administrativa - Índio</asp:ListItem>
                    </asp:DropDownList>
                </span>
            </p>
            <p>
                <span class="rotulo">Nome do Cartório</span> <span>
                    ...
                    <asp:CustomValidator ID="CustomValidatorCartorio" runat="server" Display="Dynamic"
                        Font-Size="XX-Small" ErrorMessage="Digite o Nome do Cartório" ValidationGroup="ValidationGroupCartaoSUS"
                        OnServerValidate="CustomValidatorCartorio_ServerValidate"></asp:CustomValidator></span>
                <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Existem Caracteres inválidos no Nome do Cartório"
                            ControlToValidate="tbxNomeCartorio" ValidationExpression="^[a-zA-Z0-9\s]{1,40}$"
                            Font-Size="XX-Small"></asp:RegularExpressionValidator>--%>
            </p>
            <p>
                <span class="rotulo">Certidão do Modelo Novo</span> <span>
            ...
            <p>
                ...
                <div style="position: relative; width: 300px; float: left">
                    <span class="rotulomin">Data da Emissão</span> <span>
                        ...
                        <asp:CompareValidator ID="CompareValidatorEmissaoCertidao" runat="server" ControlToValidate="tbxDataEmissaoCertidao"
                            Display="Dynamic" ErrorMessage="Data da Emissão da Certidão inválida" Operator="DataTypeCheck"
                        ...
                        <asp:CustomValidator ID="CustomValidatorDataCertidao" runat="server" Display="Dynamic"
                            ErrorMessage="Você não preencheu a Data da Certidão ou a Data é inválida" OnServerValidate="CustomValidatorDataCertidao_ServerValidate"
            ...
            <p>
                ...
                <span class="rotulomin">Série</span> <span>
                    ...
                    <asp:CustomValidator ID="CustomValidatorSerieCTPS" runat="server" Display="Dynamic"
                        ErrorMessage="Preencha a Séria da CTPS" OnServerValidate="CustomValidatorSerieCTPS_ServerValidate"
            ...
            <p>
                <span class="rotulo">Data de Emissão</span> <span>
                    ...
                    <asp:CompareValidator ID="CompareValidatorEmissaoCTPS" runat="server" ControlToValidate="tbxDataEmissaoCTPS"
                        Display="Dynamic" ErrorMessage="A data da Emissão da CTPS não é válida" Operator="DataTypeCheck"
                        Type="Date" Font-Size="XX-Small" ValidationGroup="ValidationGroupCartaoSUS"></asp:CompareValidator>
                    <asp:CustomValidator ID="CustomValidatorDataCTPS" runat="server" Display="Dynamic"
                        ErrorMessage="Preencha a Data de Emissão da CTPS" OnServerValidate="CustomValidatorDataCTPS_ServerValidate"
                        Font-Size="XX-Small" ValidationGroup="ValidationGroupCartaoSUS"></asp:CustomValidator>
                </span>
            </p>
            <p>
                <span class="rotulo">Título de Eleitor</span> <span>
            ...
            <p>
                <span class="rotulo">Seção</span> <span>
                    ...
                    <asp:CustomValidator ID="CustomValidatorSecaoEleitoral" runat="server" Display="Dynamic"
                        ErrorMessage="Preencha a Seção Eleitoral" OnServerValidate="CustomValidatorSecaoEleitoral_ServerValidate"
                        Font-Size="XX-Small" ValidationGroup="ValidationGroupCartaoSUS"></asp:CustomValidator>
                </span>
            </p>
        </fieldset>
        <fieldset class="formulario">
            ...
            <p>
                ...
                <span>
                    <br />
                    <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="O CEP 40000000 não é válido"
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="tbxCEP"
                        ErrorMessage="O CEP deve conter 8 dígitos" ValidationGroup="ValidationGroupCartaoSUS"
                    ...
                    <%--<asp:CompareValidator ID="CompareValidatorCEP" runat="server" ControlToValidate="tbxCEP"
                        Font-Size="XX-Small" Display="Dynamic" ErrorMessage="O CEP deve conter apeanas Números"
            ...
            <asp:UpdatePanel ID="UpdatePanel_Endereco" runat="server" UpdateMode="Conditional"
                ...
                <ContentTemplate>
                    <p>
                        <span class="rotulo">Município de Residência*</span> <span>
                    ...
                    <p>
                        <span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlMunicipios"
                                Display="Dynamic" ErrorMessage="Selecione o Município de Residência" Font-Size="XX-Small"
                                InitialValue="-1" ValidationGroup="ValidationGroupCartaoSUS"></asp:RequiredFieldValidator>
                        </span>
                    </p>
                </ContentTemplate>
                ...
                <ContentTemplate>
                    ...
                    <p>
                        <span class="rotulo">Nome do Logradouro*</span> <span>
                            ...
                            <asp:ImageButton ID="ImageButton_DuViverMaisEndereco" runat="server" ToolTip="DúViverMais sobre como preencher o Endereço?"
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic"
                                ErrorMessage="Existem Caracteres inválidos no Nome do Logradouro" ControlToValidate="tbxNomeLogradouro"
                    ...
                    <div id="infoEndereco" style="display: none; width: 250px; z-index: 2; opacity: 0;
                        ...
                        Se o endereço informado é: Rua das Margaridas, 13A, bloco C, Itapoan
                        <br />
                        <strong>Tipo de Logradouro:</strong> Rua
                        <br />
                        <strong>Nome do Logradouro:</strong> das Margaridas<br />
                        <strong>Número:</strong> 13<br />
                    ...
                    <p>
                        <span class="rotulo">Número*</span> <span>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbxNumero"
                                Display="Dynamic" ErrorMessage="Preencha o campo Número" Font-Size="XX-Small"
                                ValidationGroup="ValidationGroupCartaoSUS"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server"
                                Font-Size="XX-Small" ValidationGroup="ValidationGroupCartaoSUS" Display="Dynamic"
                                ControlToValidate="tbxNumero" ErrorMessage="Preencha o Número do Endereço com S/N ou Informe um Número"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="tbxNumero"
                                ValidationGroup="ValidationGroupCartaoSUS" Display="Dynamic" ErrorMessage="O campo Número do Endereço não pode ser Zero. Utilize S/N."
                ...
                <ContentTemplate>
                    <p>
                        <span class="rotulo">Complemento</span> <span>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Existem Caracteres inválidos no Nome do Complemento do Logradouro"
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlBairro"
                        Display="Dynamic" ErrorMessage="Selecione o Bairro de Residência" InitialValue="-1"
            ...
            <p>
                <span class="rotulo">Telefone</span> <span>
                    ...
                    <asp:CustomValidator ID="CustomValidator_Telefone" runat="server" ErrorMessage="Preencha o DDD com 2 dígitos e o Número do Telefone com 8 dígitos."
            ...
            <asp:CustomValidator ID="CustomValidatorIdentidadeCertidao" runat="server" Display="Dynamic"
                ErrorMessage="Preencha a Identidade ou a Certidão de Nascimento" OnServerValidate="CustomValidatorIdentidadeCertidao_ServerValidate"
                Font-Size="XX-Small" ValidationGroup="ValidationGroupCartaoSUS"></asp:CustomValidator>
            ...
            <div class="botoesroll">
                ...
                <img id="img_etiquetapdf" alt="Impressão de Etiqueta em PDF" src="../img/bts/btn_print_pdf1.png" 
            ...
            <!--div class="botoesroll">
                ...
                <img id="img_etiquetahtml" alt="Impressão de Etiqueta em HTML" src="../img/bts/btn_print_html1.png" 
    ...
    <%--    <asp:CompareValidator ID="CompareValidator3" runat="server" ErrorMessage="O CEP 40000000 não é válido"
    ...
    <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="tbxCEP"
        Display="None" ErrorMessage="O CEP deve conter apeanas Números" Operator="DataTypeCheck"
