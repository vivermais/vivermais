...
{
    public partial class ListaUsuarios : PageViverMais
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                this.WUC_PesquisarUsuario.WUC_EAS.WUC_EstabelecimentosPesquisados = new List<ViverMais.Model.EstabelecimentoSaude>();
