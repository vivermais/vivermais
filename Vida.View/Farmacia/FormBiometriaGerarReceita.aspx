<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormBiometriaGerarReceita.aspx.cs" Inherits="ViverMais.View.Farmacia.FormBiometriaGerarReceita" MasterPageFile="~/Farmacia/MasterFarmacia.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script language="JavaScript" type="text/javascript">
	...
	function writeAppletTag() {
		...
		document.writeln(buildParamTag('url', 'http://isis/Farmacia/FormGerarReceitaDispensacao.aspx?codigopaciente='));
