            ...
            <ContentTemplate>
                <fieldset class="formulario">
                    ...
                    <asp:Panel ID="panelPaciente" runat="server" Visible="false">
                        ...
                        <p>
                            <span class="rotulo">Cartão SUS</span> <span style="margin-left: 5px;">
                        ...
                        <p>
                            <span class="rotulo">Nome da Mãe</span> <span style="margin-left: 5px;">
                ...
                <asp:Panel ID="PanelResultado" runat="server" Visible="false">
                    <fieldset class="formulario">
                        ...
                        <asp:GridView ID="gridView_ResultadoReceitas" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Nº da Receita" DataField="Codigo">
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lbEmpty" runat="server" Text="Não foram encontradas receitas cadastradas para este paciente."></asp:Label>
                            </EmptyDataTemplate>
                            <PagerStyle BackColor="#006666" ForeColor="White" HorizontalAlign="Center" />
                            <HeaderStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                        </asp:GridView>
                ...
                <asp:Panel ID="PanelMedicamentos" runat="server" Visible="false">
                    <fieldset class="formulario">
                        ...
                        <asp:GridView ID="GridView_Medicamentos" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="CodMedicamento" HeaderText="Código" ReadOnly="True">
                                    <ItemStyle HorizontalAlign="center" Width="150px" VerticalAlign="Bottom" />
                                </asp:BoundField>
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lbEmpty" runat="server" Text="Não existem medicamentos prescritos para esta receita."></asp:Label>
                            </EmptyDataTemplate>
                            <HeaderStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                        </asp:GridView>
                    </fieldset></asp:Panel>
                <asp:Panel ID="PanelAtendimento" runat="server" Visible="false">
                    <fieldset class="formulario">
                        ...
                        <asp:GridView ID="GridViewAtendimentos" runat="server" AutoGenerateColumns="False" DataKeyNames="Codigo"
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lbEmpty" runat="server" Text="Não existem dispensações para esta receita."></asp:Label>
                            </EmptyDataTemplate>
                            <PagerStyle BackColor="#006666" ForeColor="White" HorizontalAlign="Center" />
                            <HeaderStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                        </asp:GridView>
                        ...
                        <asp:GridView ID="GridViewMedicamentosDispensados" runat="server" 
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="lbEmpty" runat="server" Text="Não foram dispensados medicamentos."></asp:Label>
                            </EmptyDataTemplate>
                            <HeaderStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                        </asp:GridView>
                    </fieldset></asp:Panel>
