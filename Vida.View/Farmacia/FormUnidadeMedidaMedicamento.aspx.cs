            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (Request["co_unidademedida"] != null && int.TryParse(Request["co_unidademedida"].ToString(), out temp))
                    {
                        ...
                        try
                        {
                            ViverMais.Model.UnidadeMedidaMedicamento unidade = Factory.GetInstance<IUnidadeMedidaMedicamento>().BuscarPorCodigo<ViverMais.Model.UnidadeMedidaMedicamento>(int.Parse(Request["co_unidademedida"].ToString()));
