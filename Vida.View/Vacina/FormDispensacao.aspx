...
<asp:Content ID="c_body" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div id="top">
        ...
        <fieldset class="formulario">
            <legend>Dados da Dispensação</legend>
            <p>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            ...
            <ContentTemplate>
                <asp:Panel ID="Panel_DadosDispensacao" runat="server" Visible="false">
                    <fieldset class="formulario">
                        <legend>Itens da Dispensação</legend>
                        <p>
                        ...
                        <p>
                            <span class="rotulo">Lote/Validade/Aplicação</span> <span>
                  ...
                  onmouseout="imgadicionar.src='img/btn_adicionar1.png';" /></asp:LinkButton>
                        ...
                        <p>
                            <asp:CompareValidator ID="CompareValidator6" runat="server" ErrorMessage="Estratégia é Obrigatório."
                            ...
                            <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="Imunobiológico é Obrigatório."
                                ValidationGroup="GroupAddImunobiologico" Display="None" ControlToValidate="ddlImunobiologico"
                                ValueToCompare="-1" Operator="GreaterThan"></asp:CompareValidator>
                            <asp:CompareValidator ID="CompareValidator5" runat="server" ErrorMessage="Fabricante é Obrigatório."
                                ValidationGroup="GroupAddImunobiologico" Display="None" ControlToValidate="DropDownList_Fabricante"
                                ValueToCompare="-1" Operator="GreaterThan"></asp:CompareValidator>
                            <asp:CompareValidator ID="CompareValidator7" runat="server" ErrorMessage="Lote é Obrigatório."
        ...
        <div class="botoesroll">
            <asp:LinkButton ID="lknsalvar" runat="server" OnClick="btnSalvar_click" OnClientClick="javascript:if (Page_ClientValidate('ValidationGroup_CadDispensacao')) return confirm('Todos os dados da dispensação estão corretos ?');return false;">
        ...
        <asp:CompareValidator ID="CompareValidator3" runat="server" ErrorMessage="Grupo de Atendimento é Obrigatório."
