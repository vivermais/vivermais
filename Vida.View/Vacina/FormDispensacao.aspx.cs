...
{
    public partial class FormDispensacao : PageViverMais
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    IList<SalaVacina> salas = Factory.GetInstance<ISalaVacina>().BuscarPorUsuario<SalaVacina, ViverMais.Model.Usuario>(usuario, false, true);
                    ...
                    else
                    {
                        ...
                        ddlEstrategias.DataSource = Factory.GetInstance<IViverMaisServiceFacade>().ListarTodos<Estrategia>("Descricao", true);
        ...
        {
            ViverMais.Model.Paciente paciente = WUCExibirPaciente1.Paciente;
        ...
        protected void btnSalvar_click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dispensacao.GrupoAtendimento = Factory.GetInstance<IViverMaisServiceFacade>().BuscarPorCodigo<GrupoAtendimento>(int.Parse(ddlGrupoAtendimento.SelectedValue));
