    ...
    public partial class ExibeFilaAtendimento : System.Web.UI.Page
    {
        ...
        private void CarregaAtendimentos(bool carregamentoinicial, bool ler_arquivo, string co_especialidade)
        {
            ...
            if (carregamentoinicial || existe_nova_entrada)
            {
                ...
                IList<ViverMais.Model.Prontuario> fila = iProntuario.BuscarFilaAtendimentoUnidade<ViverMais.Model.Prontuario>(((ViverMais.Model.Usuario)Session["Usuario"]).Unidade.CNES, co_especialidade);
            ...
            gridFila.DataSource = (IList<ViverMais.Model.Prontuario>)Session["FilaAtendimento"];
            gridFila.DataBind();
        }
        ...
        protected void OnRowDataBound_FormataGrid(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Session["FilaAtendimento"] != null && Session["FilaAtendimento"] is IList<ViverMais.Model.Prontuario>)
                {
