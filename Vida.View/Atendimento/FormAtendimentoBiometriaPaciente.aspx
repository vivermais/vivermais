<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormAtendimentoBiometriaPaciente.aspx.cs" Inherits="ViverMais.View.Atendimento.FormAtendimentoBiometriaPaciente" Title="Untitled Page" MasterPageFile="~/Atendimento/MasterAtendimento.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script language="JavaScript" type="text/javascript">
	...
	function writeAppletTag() {
		...
		document.writeln(buildParamTag('url', 'http://www.ViverMais.saude.salvador.ba.gov.br/Atendimento/FormAtendimento.aspx?co_paciente='));
