<%@ Page Language="C#" MasterPageFile="~/Agendamento/MasterAgendamento.Master" AutoEventWireup="true"
    CodeBehind="FormRelatorioQuantitativoProducaoESolicitacao.aspx.cs" Inherits="ViverMais.View.Agendamento.FormRelatorioQuantitativoProducaoESolicitacao"
    Title="Untitled Page" %>
        ...
        <ContentTemplate>
            <div id="top">
                ...
                <fieldset class="formulario4">
                    <legend>Relatório Quantitativo</legend>
                    <p>
                        <span class="rotulo">Selecione e tipo de relatório</span> <span>
                            <asp:RadioButtonList ID="rbtnTipoPesquisa" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                                ...
                                <asp:ListItem Value="1">De Produção</asp:ListItem>
                                <asp:ListItem Value="2">De Solicitação</asp:ListItem>
                            </asp:RadioButtonList>
                        </span>
                    </p>
...
--%>
                                ...
                                <span class="rotulo">Competência (AAAAMM)</span> <span>
                                    <asp:TextBox ID="tbxCompetencia" CssClass="campo" runat="server" MaxLength="10" Width="70px">
                                    </asp:TextBox>
                            ...
                            <p>
                                <span class="rotulo">Procedimento</span> <span>
                                    <asp:DropDownList ID="ddlProcedimento" CssClass="drop" runat="server" AutoPostBack="True"
                                        Width="550px" OnMouseOver="showTooltip(this);" OnSelectedIndexChanged="ddlProcedimento_SelectedIndexChanged">
                                        <asp:ListItem Text="Selecione..." Value="0"></asp:ListItem>
                                    </asp:DropDownList>
 ...
 --%>
                            ...
                            <p>
                                <span class="rotulo">Especialidade</span> <span>
                                    <asp:DropDownList ID="ddlEspecialidade" CssClass="drop" runat="server" AutoPostBack="True">
                                        <asp:ListItem Text="Selecione..." Value="0"></asp:ListItem>
                                    </asp:DropDownList>
