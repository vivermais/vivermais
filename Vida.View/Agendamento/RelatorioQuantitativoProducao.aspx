 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioQuantitativoProducao.aspx.cs"
    Inherits="ViverMais.View.Agendamento.RelatorioQuantitativoProducao" %>
...
<body>
    ...
    <div style="width: 1085px; height: 133px; background-image: url( 'img/topo-relatorio.jpg' );
        background-repeat: no-repeat;">
        <div style="width: 1085px; height: 60px; font-size: 26px; color: #333333; font-family: Arial;
            border: none; font-weight: bold; padding: 50px 3px 3px 20px;">
            Relatório Quantitativo de Produção
        </div>
        <br />
        ...
        <asp:GridView ID="GridViewQuantitativo" runat="server" AutoGenerateColumns="False"
            ...
            <RowStyle BackColor="#afc1e2" ForeColor="Black" Font-Size="9px" Font-Names="Arial"
            ...
            <HeaderStyle BackColor="#78b9cbd" Font-Bold="True" ForeColor="White" Font-Names="Verdana"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="QTD Publicada" DataField="QuantidadePublicada" />
                <asp:BoundField HeaderText="QTD Agendado" DataField="QuantidadeAgendado" />
                <asp:BoundField HeaderText="QTD Confirmado" DataField="QuantidadeConfirmado" />
                <asp:BoundField HeaderText="QTD Não Confirmado" DataField="QuantidadeNaoConfirmado" />
            </Columns>
        </asp:GridView>
        <br />
    </div>
