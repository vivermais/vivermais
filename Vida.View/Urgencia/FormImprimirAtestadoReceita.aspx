<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormImprimirAtestadoReceita.aspx.cs"
    Inherits="ViverMais.View.Urgencia.FormImprimirAtestadoReceita" %>
...
<body>
    <form id="form1" runat="server" style="height: 595px; width: 410px;">
    <asp:DataList ID="DataList_AtestadoReceita" runat="server" DataKeyField="Codigo"
        OnItemDataBound="OnItemDataBound_ConfigurarDataList">
        <ItemTemplate>
            ...
            <asp:Table ID="Tabela_AtestadoReceita" runat="server">
                <asp:TableRow HorizontalAlign="Center" BorderColor="Black"
                Width="855px" Height="128px" Style="background-repeat: no-repeat;">
                    <asp:TableCell>
...
<%--                <asp:TableRow>
                ...
                <asp:TableRow>
                    <asp:TableCell>
                                    <p><asp:Label ID="LabelSiglaReceita" runat="server" Text="R/" Visible="false"></asp:Label>&nbsp</p>
                    </asp:TableCell>
                </asp:TableRow>
...
<%--                <asp:TableRow>
                ...
                <asp:TableRow HorizontalAlign="Center" Width="100%" Font-Bold="true" Font-Names="Verdana"
                    ...
                    <asp:TableCell Width="100%">
                        ...
                        <br />
                        CRM-BA:<asp:Label ID="Label5" Font-Bold="true" runat="server" Font-Names="Verdana" Font-Size="12px"
                            Text='<%#bind("CRMProfissional") %>'></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
