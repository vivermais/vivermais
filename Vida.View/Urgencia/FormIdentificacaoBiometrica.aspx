<%@ Page Language="C#" MasterPageFile="~/Urgencia/MasterUrgencia.Master" AutoEventWireup="true"
    CodeBehind="FormIdentificacaoBiometrica.aspx.cs" Inherits="ViverMais.View.Urgencia.FormIdentificacaoBiometrica"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	function writeAppletTag() {
		...
		//document.writeln(buildParamTag('url', 'http://isis/Urgencia/FormPaciente.aspx?tipo_paciente=2&codigo='));
		document.writeln(buildParamTag('url', 'http://192.168.227.1/Urgencia/FormPaciente.aspx?tipo_paciente=pacientesimplificado&codigo='));
