<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Urgencia/MasterUrgencia.Master" CodeBehind="FormBiometriaIdentificarPaciente.aspx.cs" Inherits="ViverMais.View.Urgencia.FormBiometriaIdentificarPaciente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	function writeAppletTag() {
		...
		//document.writeln(buildParamTag('url','http://isis/Urgencia/FormAssociarPacientes.aspx?codigo='));
		document.writeln(buildParamTag('url', 'http://192.168.227.1/Urgencia/FormAssociarPacientes.aspx?co_paciente='));
