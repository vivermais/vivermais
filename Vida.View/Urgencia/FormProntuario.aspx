	...
	<img id="grafatendimentos" alt="Quadro de Vagas" src="img/btn_graficoatendimento1.png"
        ...
        <fieldset class="formulario1">
            ...
            <cc1:TabContainer ID="TabContainer2" runat="server" Width="720px">
                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="Primeira Consulta Médica">
                    <ContentTemplate>
                        <cc1:TabContainer ID="TabContainer1" runat="server">
                            <cc1:TabPanel ID="TabPanel_Um" runat="server" HeaderText="Dados Registro Eletrônico">
                                <ContentTemplate>
                                    <fieldset class="formulario2">
                                        ...
                                        <p>
                                            <span class="rotulo">Horário da Classificação Risco:</span> <span>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel_IdentificacaoPaciente" runat="server" UpdateMode="Conditional"
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_NomePaciente" Font-Size="XX-Small"
                                                    runat="server" ErrorMessage="Nome do Paciente é Obrigatório" ControlToValidate="tbxNomePaciente"
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_Idade" Font-Size="XX-Small"
                                                    runat="server" ErrorMessage="Idade é Obrigatório!" ControlToValidate="tbxIdade"
                                                    Display="None" ValidationGroup="ValidationGroup_cadProntuarioMedico"></asp:RequiredFieldValidator>
                                        ...
                                        <p>
                                            <span class="rotulo">Situação Atual:</span> <span>
...
<%--                                        <p>
                                            ...
                                            <div id="info" style="display: none; width: 250px; z-index: 2; opacity: 0; filter: progid:DXImageTransform.Microsoft.Alpha(opacity=0);
                                                ...
                                                Caso o peso do paciente, freqüência cardíaca, freqüência respiratória, tensão arterial,
                                                temperatura, hgt contenha parte fracionária utilize a vírgula para indicá-la. Exemplo:
                                                100,30 ou 100,3.
                                            </div>
                                        </p>--%>
                                        <p>
                                            <span class="rotulo">Freq. Cardíaca:</span> <span>
                                        ...
                                        <p>
                                            <span class="rotulo">Freq. Respiratória:</span> <span>
                                        ...
                                        <p>
                                            <span class="rotulo">Tensão Arterial:</span> <span>
                                                ...
                                                <p>
                                                    <span>
                                                        <asp:GridView ID="gridCid" OnRowDeleting="gridCid_RowDeleting" runat="server" Width="630px"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundField DataField="Codigo" HeaderText="Código" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" />
                                    ...
                                    <fieldset class="formulario2">
                                        <legend>Anamnese/Exame Físico</legend>
                                        <p>
                                            <span>
                                    ...
                                    <div>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator" Font-Size="XX-Small"
                                            runat="server" ErrorMessage="Idade deve conter somente números!" ValidationGroup="ValidationGroup_cadProntuarioMedico"
...
<%--                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="^(\d{1,}\,\d{1,})|(\d*)$"
                                            ...
                                            Display="None" ErrorMessage="Peso com formato inválido.">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ValidationExpression="^(\d{1,}\,\d{1,})|(\d*)$"
                                            ...
                                            Display="None" ErrorMessage="Freqüência Cardíaca com formato inválido.">
                                        </asp:RegularExpressionValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ValidationExpression="^(\d{1,}\,\d{1,})|(\d*)$"
                                            ...
                                            Display="None" ErrorMessage="Freqüência Respiratória com formato inválido.">
                                        </asp:RegularExpressionValidator>
                                        <%--                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                                ...
                                                <ContentTemplate>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator_TensaoInicio" runat="server" ErrorMessage="Máxima da Tensão Arterial é Obrigatório!"
                                        ...
                                        <%--                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                                ...
                                                <ContentTemplate>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator_TensaoFim" runat="server" ErrorMessage="Mínima da Tensão Arterial é Obrigatório!"
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ValidationExpression="^(\d{1,}\,\d{1,})|(\d*)$"
                                            ...
                                            Display="None" ErrorMessage="Temperatura com formato inválido.">
                                        </asp:RegularExpressionValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ValidationExpression="^(\d{1,}\,\d{1,})|(\d*)$"
                                            ...
                                            Display="None" ErrorMessage="HGT com formato inválido.">
                                        </asp:RegularExpressionValidator>
                                        <asp:UpdatePanel ID="UpdatePanel_Grupo" runat="server" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_Anamnese" Font-Size="XX-Small"
                                                    runat="server" ErrorMessage="Anamnese/Exame Físico é Obrigatório!" ControlToValidate="tbxAvaliacaoMedica"
                                                    Display="None" ValidationGroup="ValidationGroup_cadProntuarioMedico"></asp:RequiredFieldValidator>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_SumarioAlta" runat="server"
                                                    ErrorMessage="Sumário de Alta é Obrigatório!" Display="None" ValidationGroup="ValidationGroup_cadProntuarioMedico"
                                        ...
                                        <asp:CompareValidator ID="CompareValidator3" Font-Size="XX-Small" runat="server"
                                            ErrorMessage="Situação é Obrigatório!" ControlToValidate="ddlSituacao" Display="None"
                            ...
                            <cc1:TabPanel ID="TabPanel_Dois" runat="server" HeaderText="Prescrição">
                                <ContentTemplate>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel_Quatro" runat="server" UpdateMode="Conditional"
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator_FrequenciaProcedimento" runat="server"
                                                        ErrorMessage="Freqüência é Obrigatório!" Display="None" ValidationGroup="ValidationGroup_cadProcedimento"
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator_FrequenciaProcedimento" runat="server"
                                                        ErrorMessage="Freqüência deve ser maior que zero." ControlToValidate="TextBox_IntervaloProcedimento"
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel_Quinze" runat="server" UpdateMode="Conditional"
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator_FrequenciaProcedimentoNaoFaturavel"
                                                        runat="server" ErrorMessage="Freqüência é Obrigatório!" Display="None" ValidationGroup="ValidationGroup_cadProcedimentoNaoFaturavel"
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator_FrequenciaProcedimentoNaoFaturavel" runat="server"
                                                        ErrorMessage="Freqüência deve ser maior que zero." ControlToValidate="TextBox_IntervaloProcedimentoNaoFaturavel"
                                        ...
                                        <fieldset class="formulario3">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel_Onze" runat="server" UpdateMode="Conditional" RenderMode="Inline"
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <p>
                                                        <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="Selecione um(a) medicamento/prescrição!"
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_FrequenciaMedicamento" runat="server"
                                                            ErrorMessage="Freqüência é Obrigatório!" Display="None" ControlToValidate="tbxIntervaloMedicamento"
                                                        ...
                                                        <asp:CompareValidator ID="CompareValidator_FrequenciaMedicamento" runat="server"
                                                            ErrorMessage="Freqüência deve ser maior que zero." ControlToValidate="tbxIntervaloMedicamento"
                            ...
                            <cc1:TabPanel ID="TabPanel_Tres" runat="server" HeaderText="Solicitação de Exames"
                                Enabled="true">
                                <ContentTemplate>
                                    <fieldset class="formulario2">
                                ...
                                <asp:Panel ID="Panel_Acoes" runat="server" Visible="false">
                                    ...
                                    <div id="Div2" style="position: fixed; top: 100px; left: 25%; width: 600px; z-index: 102;
                                        ...
                                        <div style="padding-left: 0px;">
                                            <p>
                                                <span>
                                                    <asp:Label ID="Label_InfoConfirmarFatura" runat="server" Text="Ações" Font-Bold="true"
	...
	<img id="btnsair" alt="Sair" src="img/btn-sair-1.png"
                                ...
                                <p align="center">
                                    <span>
                                        <asp:ImageButton ID="btnSalvar1" runat="server" ImageUrl="~/Urgencia/img/bts/btn_salvar1.png"
                                            Width="134px" Height="38px" CausesValidation="true" OnClientClick="javascript:if (Page_ClientValidate('ValidationGroup_cadProntuarioMedico')) return confirm('Todos os dados informados para este atendimento estão corretos ?'); return false;"
                ...
                <cc1:TabPanel ID="TabHistorico" runat="server" HeaderText="Histórico">
                    <ContentTemplate>
                        <fieldset class="formulario2">
                            <legend>Informações Disponíveis</legend>
                            <p>
                                <span>
