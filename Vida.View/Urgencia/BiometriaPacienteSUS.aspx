<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BiometriaPacienteSUS.aspx.cs" Inherits="ViverMais.View.Urgencia.BiometriaPacienteSUS" Title="Untitled Page" MasterPageFile="~/Urgencia/MasterUrgencia.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script language="JavaScript" type="text/javascript">
	...
	function writeAppletTag() {
		...
		document.writeln(buildParamTag('url', 'http://192.168.227.1/Urgencia/FormPaciente.aspx?tipo_paciente=pacientesus&codigo='));
