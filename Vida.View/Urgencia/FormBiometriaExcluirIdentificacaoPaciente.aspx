<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormBiometriaExcluirIdentificacaoPaciente.aspx.cs"
 Inherits="ViverMais.View.Urgencia.FormBiometriaExcluirIdentificacaoPaciente" MasterPageFile="~/Urgencia/MasterUrgencia.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script language="JavaScript" type="text/javascript">
	...
	function writeAppletTag() {
		...
		document.writeln(buildParamTag('url', 'http://192.168.227.1/Urgencia/FormExcluirIdentificacaoPaciente.aspx?co_paciente='));
		//		document.writeln(buildParamTag('url', 'http://isis/Urgencia/FormExcluirIdentificacaoPaciente.aspx?co_paciente='));
